...
export const SizeSchema = z
  .record(
    z.enum(['sm', 'md']),
    z.enum(['4x1', '2x2', '2x4', '4x2', '4x4', '4x5'])
  )
  .default({
    sm: '2x2',
    md: '2x2',
...
export const PodcastsBentoSchema = z.object({
  id: z.string(),
...
export const YouTubeChannelsBentoSchema = z.object({
  id: z.string(),
...
export const BooksBentoSchema = z.object({
  id: z.string(),
...
export const FavoritesBentoSchema = z.object({
  id: z.string(),
...
export const BentoSchema = LinkBentoSchema.or(NoteBentoSchema)
  ...
  .or(MusicBentoSchema)
  .or(PodcastsBentoSchema)
  .or(YouTubeChannelsBentoSchema)
  .or(BooksBentoSchema)
  .or(FavoritesBentoSchema)
